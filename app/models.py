...
class Site(Base):
    ...
    house_range_begin: Mapped[Optional[str]] = mapped_column(String(36))
    house_range_end: Mapped[Optional[str]] = mapped_column(String(36))
    house: Mapped[Optional[str]] = mapped_column(String(36))
    house_lit: Mapped[Optional[str]] = mapped_column(String(36))
    block: Mapped[Optional[str]] = mapped_column(String(36))
    building: Mapped[Optional[str]] = mapped_column(String(36))
    house_range_begin_lit: Mapped[Optional[str]] = mapped_column(String(36))
    house_range_end_lit: Mapped[Optional[str]] = mapped_column(String(36))
    house_range_begin_block: Mapped[Optional[str]] = mapped_column(String(36))
    house_range_end_block: Mapped[Optional[str]] = mapped_column(String(36))
